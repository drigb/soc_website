...
fips_path <-'/Users/davidrigby/Dropbox/akram_demo/nation_county_fips.csv'
...
covid_path <- '/Users/davidrigby/Dropbox/akram_demo/us-counties.csv'
...
share_dot_map <- covid_share %>%
  ...
  addLegend("topright", colors = "white", labels = "",
            title = "<B> Counts as of: 2020-04-01"
  )
...
gif_path <- '/Users/davidrigby/Dropbox/akram_demo/covid_map.gif'
g <- image_read(gif_path)
g
